...
- **Superseded 2026-08-27**: the plain-approver rendering gate described here was relaxed by #04 — the editable section now renders for any user holding the `approver` role, including one who also holds `lead_approver`.